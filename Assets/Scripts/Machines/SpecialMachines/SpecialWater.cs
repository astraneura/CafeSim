...
public class SpecialWater : MonoBehaviour, IOrderStepSourceInterface
{
    [SerializeField] private Ingredient water;
    ...
    private void CompleteWork()
    {
        ...
        {
            DrinkManager.Instance.CalculateEmotionalValue(water);
            DrinkManager.Instance.CalculatePhysicalValue(water);
        }
    }
