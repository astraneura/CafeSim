...
public class SpecialEspresso : MonoBehaviour, IOrderStepSourceInterface
{
    [SerializeField] private Ingredient espresso;
    ...
    private void CompleteWork()
    {
        ...
        {
            DrinkManager.Instance.CalculateEmotionalValue(espresso);
            DrinkManager.Instance.CalculatePhysicalValue(espresso);
        }
    }
